  ...
  return (
    <section className="relative py-32 md:py-40 px-6 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image src="/elegant-woman-hands-with-golden-manicure-dark-back.jpg" alt="" fill className="object-cover" />
      ...
      <div className="container mx-auto max-w-3xl text-center relative z-10">
        <p className="text-sm uppercase tracking-[0.3em] text-accent mb-4 font-sans">Your Transformation Awaits</p>
        ...
        <p className="text-lg text-muted-foreground mb-10 max-w-xl mx-auto leading-relaxed font-sans">
          Book your appointment today and experience the transformation. Online booking available or reach us via
          WhatsApp.
        </p>
        <Link
          href="#contact"
