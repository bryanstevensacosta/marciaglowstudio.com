...
const features = [
  {
    ...
    description:
      'Our skilled stylists bring years of experience and continuous training in the latest techniques.',
  },
  {
    icon: ShieldCheck,
    title: 'Premium Products',
    description:
      'We exclusively use high-quality, salon-grade products that nurture and protect your hair and nails.',
  },
  {
    icon: Star,
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          {features.map((feature, index) => (
            <div key={index} className="text-center">
              ...
              <h3 className="text-xl font-medium text-foreground mb-3 font-sans">
                {feature.title}
              </h3>
